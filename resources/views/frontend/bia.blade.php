...
@section('content')
 ...
 <div class="container-fluid bg-breadcrumb">
    <div class="container text-center py-5" style="max-width: 900px;">
        <h3 class="text-white display-3 mb-4">BIA</h1>
...
<div class="container-fluid blog py-4">
    <div class="container py-4">
        <div class="mx-auto text-center mb-5" style="max-width: 900px;">
            <h5 class="section-title px-3">APA ITU BIA?</h5>
            <h1 class="mb-4">Bina Iman Anak-Anak</h1>
            ...
            <h5 class="section-title px-3" style="margin: 20px">Pendaftaran BIA</h5>
